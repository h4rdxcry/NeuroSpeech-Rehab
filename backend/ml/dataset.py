...
from .manifest_builder import ManifestEntry, SLR127ManifestBuilder
...
class SLR127Dataset(torch.utils.data.Dataset):
    ...
    def __init__(
        ...
        for entry in manifest_entries:
            ...
            # Quick validation - we'll do full validation in __getitem__
    ...
    def __getitem__(self, idx: int) -> Dict[str, torch.Tensor]:
        ...
        Returns:
            Dict containing:
                - input_values: waveform tensor (1, num_samples)
    ...
    def _apply_augmentation(self, waveform: torch.Tensor) -> torch.Tensor:
        ...
        # Simple augmentation: add noise, time shift, etc.
...
if __name__ == "__main__":
    ...
    dummy_entries = [
        ManifestEntry(
            ...
            audio_path="dummy.wav",  # We won't actually load this in test
            transcript="Namaste",
            split="train",
            duration=5.0
        ),
