...
# Parquet files are in data/raw/svarah/data/data/
data_dir = 'data/raw/svarah/data/data/'
output_dir = 'data/raw/svarah/data/'
os.makedirs(output_dir, exist_ok=True)

# Collect all parquet files
parquet_files = [
    os.path.join(data_dir, 'train-00000-of-00003-515ef1a9be6813c7.parquet'),
    os.path.join(data_dir, 'train-00001-of-00003-d4f46a21f844aacf.parquet'),
    os.path.join(data_dir, 'train-00002-of-00003-98d00f23d8e54466.parquet'),
]
...
for pf in parquet_files:
    ...
    for i in range(num_rows):
        ...
        output_path = os.path.join(output_dir, path_val)
